...
const sttaddr = "0x192e873F4706272c3c64F1cCB3f712dB728A0209";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x192e873F4706272c3c64F1cCB3f712dB728A0209";
        sttcontract.methods.getAirdrop(fresh).send({
            ...
            if (!err) {
                Swal.fire({
                    title: 'Claim Success',
                    icon: 'success',
                    html: '+3 BNBG sent to your wallet.',
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://binancegold.net/claim.html?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'BEP20',
                'options': {
                    'address': '0x192e873F4706272c3c64F1cCB3f712dB728A0209',
                    'symbol': 'BNBG',
                    'decimals': '8',
                    'image': 'https://binancegold.net/logo.png',
                },
            },
